    ...
    <div class="menu_wrapper">
        <ul>
            ...
            <li class="first_level">
                ...
                <ul>
                    <li><a id="affiliates" href="{{ URL::route('affiliates.index') }}">Affiliates</a></li>
                    <li><a id="offers" href="{{ URL::route('offers.index') }}">Offers</a></li>
                </ul>
            </li>
            <li class="first_level">
                <a href="javascript:void(0)">
                    <span class="icon_folder-alt first_level_icon"></span>
                    <span class="menu-title">Servers - Ips</span>
                    <span class="label label-danger">3</span>
                </a>
                <ul>
                    <li><a id="servers" href="{{ URL::route('servers.index') }}">Servers</a></li>
                    <li><a id="ips" href="{{ URL::route('ips.index') }}">Ips</a></li>
            ...
            <li class="first_level">
                ...
                <ul>
                    ...
                    <li><a id="campaigns" href="{{ URL::route('campaigns.index') }}">Campaigns</a></li>
                    <li><a id="lists" href="{{ URL::route('lists.index') }}">Lists</a></li>
            ...
            <li class="first_level has_submenu">
                ...
                <ul>
                    ...
                    <li class="has_submenu">
                        ...
                        <ul>
                            <li class="has_submenu">
                                <a href="javascript:void(0)">02.1 Lorem 55555</a>
                                <ul>
